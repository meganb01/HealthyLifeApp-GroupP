...
public class SleepGUI extends javax.swing.JFrame {
    ...
    private void updateSummary() {
        ...
        double avg = s.getAverageHours(); // Get the average sleep duration stored in SleepManager
         ...
         viewColorBarPnl.removeAll();
         viewColorBarPnl.invalidate();
         viewColorBarPnl.validate();
        ...
        if (totalWidth < 10) {
            totalWidth = viewColorBarPnl.getPreferredSize().width;
        }
        if (totalWidth < 10) {
            totalWidth = 300; // last fallback
        }
